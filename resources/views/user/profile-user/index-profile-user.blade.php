...
<body>
    {{-- navbar --}}
    <nav class="navbar navbar-expand-lg p-0" aria-label="Thirteenth navbar example" style="background-color:  #724e2d">
    ...
    <div class="position-absolute bg-light shadow-blur container bg-opacity-75 shadow"
        style="display: flex; justify-content: flex-end; z-index: 99;">
        <div id="userDropdown"
            class="user-dropdown position-absolute shadow-blur bg-opacity-25 p-3 shadow"style="margin-left: auto;">
    ...
    <!-- side bar -->
    <div class="div-main-container d-flex rounded">
